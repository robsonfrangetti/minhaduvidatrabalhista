...
export const topics: Record<string, TopicData> = {
  ...
  "atestado-medico": {
    id: "atestado-medico",
    order: 11,
    title: "Quais são meus direitos com atestado médico?",
    description: "Direitos trabalhistas, faltas justificadas, estabilidade e pagamentos durante licença médica",
    keywords: ["direitos atestado", "atestado médico", "falta justificada", "licença médica", "estabilidade", "auxílio doença"],
    legislation: [
      {
        title: "CLT - Art. 473",
        ...
        interpretation: "Em linguagem simples: FALTAS JUSTIFICADAS = SEM PERDA DE SALÁRIO! Você pode faltar sem perder salário em situações específicas: morte de parentes (2 dias), casamento (3 dias), nascimento de filho (1 dia), doação de sangue (1 dia/ano), alistamento eleitoral (2 dias), serviço militar, vestibular, comparecimento em juízo. ⚠️ IMPORTANTE: Empresa NÃO pode descontar do salário. DICA: Guarde comprovantes dessas situações!"
      },
      {
        title: "CLT - Art. 474",
        ...
        interpretation: "Em linguagem simples: ATESTADO MÉDICO para faltas por doença! Para mais de 1 dia = atestado médico obrigatório. Para 1 dia = CLT permite declaração própria. ⚠️ ATENÇÃO NA PRÁTICA: MAIORIA das empresas NÃO aceita declaração própria e EXIGE atestado sempre! DICA: Consulte regulamento da empresa - pode ter regras mais rígidas!"
      },
      {
        title: "CLT - Art. 475",
        ...
        interpretation: "Em linguagem simples: ATESTADO deve ser apresentado NO PRIMEIRO DIA de retorno! Se não apresentar sem motivo justo, perde salário do período que faltou. ⚠️ CUIDADO: Atestado médico falso = demissão por justa causa! DICA: Sempre seja honesto com atestados médicos!"
      }
    ],
    ordinances: [
      {
        ...
        interpretation: "Em linguagem simples: REGRAS do controle de ponto com atestados! Empresa DEVE: registrar faltas automaticamente, não descontar salário durante atestado válido, manter arquivo por 5 anos, verificar autenticidade. ⚠️ IMPORTANTE: Atestado deve ter CRM, período, diagnóstico, assinatura. DICA: Empresa não pode exigir atestado para 1 dia (pode ser declaração própria)!"
      }
    ],
    summaries: [
      {
        ...
        interpretation: "Em linguagem simples: DOENÇA SEM ATESTADO NO PRAZO ≠ ABANDONO! Se ficou doente e não conseguiu apresentar atestado no prazo, NÃO é abandono de emprego. ⚠️ IMPORTANTE: Pode comprovar depois que estava doente. DICA: Empresa não pode demitir por abandono só por isso!"
      },
      {
        number: "Súmula 268",
        court: "TST - Tribunal Superior do Trabalho",
        ...
        interpretation: "Em linguagem simples: ATESTADO ATRASADO = DIREITO AO SALÁRIO! Mesmo apresentando atestado fora do prazo, tem direito ao salário se provar impossibilidade de apresentar no prazo. ⚠️ IMPORTANTE: Exemplos: muito doente, hospitalizado, médico só emitiu depois. DICA: Documente a impossibilidade!"
      },
      {
        number: "Súmula 372",
        court: "TST - Tribunal Superior do Trabalho",
        ...
        interpretation: "Em linguagem simples: DOENÇA COM ATESTADO ≠ FALTA INJUSTIFICADA! Mesmo atestado atrasado, não é falta injustificada se provar impossibilidade de apresentar no prazo. ⚠️ IMPORTANTE: Protege você de perder direitos por questões burocráticas. DICA: Questões além do seu controle não podem prejudicar você!"
      }
    ],
    jurisprudence: [
      {
        ...
        interpretation: "Em linguagem simples: MAIS DE 15 DIAS = AUXÍLIO DOENÇA INSS! Empresa para de pagar salário, mas você continua funcionário. ⚠️ IMPORTANTE: INSS paga o auxílio, empresa mantém vínculo. DICA: Quando melhorar, volta normalmente ao trabalho!"
      },
      {
        ...
        interpretation: "Em linguagem simples: CLT permite declaração própria para 1 dia de doença. PORÉM NA PRÁTICA, muitas empresas têm regulamentos internos que exigem atestado sempre. ⚠️ IMPORTANTE: Regulamentos internos podem ser mais rígidos que a CLT. DICA: Verifique regras da SUA empresa - pode ter falta descontada se não seguir!"
      },
      {
        ...
        interpretation: "Em linguagem simples: ATESTADO FALSO = JUSTA CAUSA! Se apresentar atestado falso, empresa pode demitir sem direitos. ⚠️ IMPORTANTE: Empresa precisa PROVAR que é falso. DICA: Nunca falsifique atestados - é crime e você perde tudo!"
      }
    ],
    recentDecisions: [
      {
  ...
  "atrasos": {
    id: "atrasos",
    order: 10,
    title: "Posso ser descontado por atrasos no trabalho?",
    description: "Tolerância de atrasos, descontos salariais, consequências e demissão por justa causa",
    keywords: ["desconto atraso", "tolerância atraso", "ponto eletrônico", "desconto salarial", "justa causa", "atrasos frequentes"],
    legislation: [
      {
        title: "CLT - Art. 58, § 1º",
        ...
        interpretation: "Em linguagem simples: TOLERÂNCIA de até 5 minutos por marcação, máximo 10 minutos/dia! Exemplo: chegou 3min atrasado + saiu 4min depois = 7min total (dentro da tolerância). ⚠️ IMPORTANTE: Se passar dos 10min/dia, empresa pode descontar TODO o atraso! DICA: Tolerância NÃO é direito de chegar atrasado - é só margem para imprevistos!",
      ...
      },
      {
        ...
        interpretation: "Em linguagem simples: ATRASOS FREQUENTES = JUSTA CAUSA! Atrasos injustificados podem ser considerados desídia (desleixo) e levar à demissão por justa causa. ⚠️ IMPORTANTE: Perde aviso prévio, multa FGTS, seguro-desemprego! DICA: Empresa geralmente: 1ª vez = advertência verbal, 2ª vez = escrita, 3ª vez = suspensão, reincidência = justa causa!",
      ...
      },
      {
        ...
        interpretation: "Em linguagem simples: SUSPENSÃO + 30 DIAS = DEMISSÃO SEM JUSTA CAUSA! Se empresa te suspender por mais de 30 dias seguidos, vira demissão sem justa causa. ⚠️ IMPORTANTE: Tem direito a aviso prévio, multa FGTS, seguro-desemprego, férias e 13º proporcionais! DICA: É proteção contra empresas que tentam forçar pedido de demissão!",
    ...
    ordinances: [
      {
        ...
        interpretation: "Em linguagem simples: REGRAS do controle de ponto! Até 10min/dia não descontam, MAS se passar disso, TODO tempo é descontado! ⚠️ IMPORTANTE: Empresa PODE descontar atrasos do salário (deve aparecer no holerite). Punições: advertência → suspensão → justa causa. DICA: Atrasos por saúde/força maior são justificados - AVISE o chefe imediatamente!",
    ...
    summaries: [
      {
        ...
        interpretation: "Em linguagem simples: TOLERÂNCIA de 10min/dia confirmada! MAS ATENÇÃO: se atrasar 11min, empresa pode descontar OS 11 MINUTOS COMPLETOS! ⚠️ IMPORTANTE: Não é só o que passou da tolerância. DICA: Exemplo: 12min de atraso = desconto dos 12min, não só 2min!",
      ...
      },
      {
        ...
        interpretation: "Em linguagem simples: DESCONTO por atrasos é VÁLIDO se estiver no contrato/regulamento ou se for intencional (dolo)! ⚠️ IMPORTANTE: Maioria das empresas inclui cláusula de desconto no contrato. DICA: Verifique seu contrato e regulamento interno!",
        link: "https://www.tst.jus.br/sumulas"
      }
    ],
    jurisprudence: [
      {
        ...
        interpretation: "Em linguagem simples: GRADAÇÃO para demissão por justa causa: 1) Advertência verbal, 2) Escrita, 3) Suspensão, 4) Justa causa. ⚠️ IMPORTANTE: Guarde cópia de toda advertência! DICA: Se empresa não seguir gradação, pode contestar na Justiça!"
      },
      {
        ...
        interpretation: "Em linguagem simples: DSR (folga remunerada) pode ser DESCONTADO por atrasos! Se atrasar na semana sem justificativa, empresa pode descontar DSR (perde dia de folga). ⚠️ IMPORTANTE: É legal SE estiver no regulamento/acordo coletivo. DICA: Verifique se está previsto - se não estiver, desconto pode ser indevido!"
      },
      {
        ...
        interpretation: "Em linguagem simples: ATRASO JUSTIFICADO ≠ DESCONTO! Se atrasa por motivos fora do controle e consegue provar, empresa NÃO PODE descontar nem punir. ⚠️ IMPORTANTE: AVISE imediatamente + GUARDE provas + APRESENTE no retorno. DICA: Exemplos: acidente, enchente, greve transporte, emergência médica!"
      }
    ],
    recentDecisions: [
      {
  ...
  "gravidez": {
    id: "gravidez",
    order: 11,
    title: "Quais são os direitos da gestante no trabalho?",
    description: "Estabilidade, licença-maternidade, amamentação, creche e proteções trabalhistas",
    keywords: ["direitos gestante", "gestante trabalho", "estabilidade gravidez", "licença maternidade", "amamentação", "creche"],
    legislation: [
      {
        ...
        interpretation: "Em linguagem simples: ESTABILIDADE desde confirmação da gravidez até 5 meses APÓS o parto! Mesmo sem contar para empresa, se estava grávida quando demitida, tem direito à reintegração. ⚠️ IMPORTANTE: Empresa NÃO precisa saber - se estava grávida no dia da demissão, é nula! DICA: Faça exame logo após demissão para comprovar!",
      ...
      },
      {
        ...
        interpretation: "Em linguagem simples: LICENÇA-MATERNIDADE = 120 DIAS (4 meses) com salário completo! Pode começar até 28 dias ANTES do parto. ⚠️ IMPORTANTE: Se médico recomendar, pode aumentar mais 2 semanas antes e depois. DICA: Empresas do Programa Empresa Cidadã podem estender para 180 dias (6 meses)!",
      ...
      },
      {
        ...
        interpretation: "Em linguagem simples: DIREITO a MÍNIMO 6 FALTAS para consultas e exames SEM DESCONTO NO SALÁRIO! Se trabalho oferece risco, pode pedir mudança de função temporária. ⚠️ IMPORTANTE: Sempre leve comprovante da consulta para RH. DICA: Empresa não pode descontar essas faltas!",
        link: "http://www.planalto.gov.br/ccivil_03/decreto-lei/del5452.htm#art392"
      },
      {
        ...
        interpretation: "Em linguagem simples: DIREITO a 2 PAUSAS DE 30 MINUTOS/dia para amamentar até bebê completar 6 MESES! Pausas são DENTRO do horário de trabalho. ⚠️ IMPORTANTE: Se médico recomendar, pode estender por mais tempo. DICA: Muitas empresas permitem sair 1h mais cedo ou entrar 1h mais tarde!",
      ...
      },
      {
        ...
        interpretation: "Em linguagem simples: GESTANTE deve ser AFASTADA de trabalho insalubre (produtos químicos, barulho, etc.)! Empresa DEVE mudar para local salubre. ⚠️ IMPORTANTE: Continua recebendo adicional de insalubridade MESMO em local salubre! DICA: Se não tiver local salubre, afasta e recebe salário-maternidade INSS!",
      ...
      },
      {
        ...
        interpretation: "Em linguagem simples: EMPRESA com 30+ mulheres É OBRIGADA a oferecer creche ou auxílio-creche! Pode ser creche própria, convênio ou auxílio financeiro. ⚠️ IMPORTANTE: Muitas empresas não cumprem! Se não oferecer, pode ser multada. DICA: Pergunte quantas mulheres trabalham na empresa - se for 30+, exija creche!",
    ...
    ordinances: [
      {
        ...
        interpretation: "Em linguagem simples: PROGRAMA EMPRESA CIDADÃ = 180 DIAS (6 meses) de licença! Mas só vale se empresa aderir voluntariamente. ⚠️ IMPORTANTE: Você precisa PEDIR até 1 mês após o parto. DICA: Maioria das empresas privadas NÃO participa - pergunte ao RH!",
    ...
    summaries: [
      {
        ...
        interpretation: "Em linguagem simples: DEMITIDA GRÁVIDA = pode pedir REINTEGRAÇÃO se ainda no período de estabilidade! Se período já acabou, só recebe indenização. ⚠️ IMPORTANTE: PROCESSE RÁPIDO para ter opção de voltar a trabalhar! DICA: Estabilidade vai até 5 meses após o parto!",
        link: "https://www.tst.jus.br/sumulas"
      },
      {
        number: "Súmula 30",
        ...
        interpretation: "Em linguagem simples: CONTRATO TEMPORÁRIO + GRAVIDEZ = ESTABILIDADE! Mesmo em contrato por prazo determinado, tem direito à estabilidade. ⚠️ IMPORTANTE: Contrato se estende automaticamente até 5 meses após parto. DICA: NÃO vale para obra certa ou safra, mas vale para experiência e temporários normais!",
        link: "https://www.tst.jus.br/sumulas"
      }
    ],
    jurisprudence: [
      {
        ...
        interpretation: "Em linguagem simples: ESTABILIDADE mesmo sem saber da gravidez! O que importa: estava grávida no dia da demissão? Se sim, tem direito! ⚠️ IMPORTANTE: Faça exame de sangue LOGO após demissão para comprovar. DICA: Se há possibilidade de estar grávida, faça exame IMEDIATAMENTE!"
      },
      {
        ...
        interpretation: "Em linguagem simples: AMAMENTAÇÃO pode ser convertida em sair 1h mais cedo ou entrar 1h mais tarde! ⚠️ IMPORTANTE: Precisa ser ACORDADO com empresa. DICA: Faça acordo POR ESCRITO para evitar problemas!"
      },
      {
        ...
        interpretation: "Em linguagem simples: ADICIONAL DE INSALUBRIDADE é MANTIDO durante gravidez! Se transferida para local seguro, continua recebendo o adicional. ⚠️ IMPORTANTE: Não perde nada no salário. DICA: Exemplo: R$ 2.000 + R$ 400 insalubridade = continua recebendo R$ 2.400!"
      }
    ],
    recentDecisions: [
      {
  ...
  "falta-declaracao-horas": {
    ...
    legislation: [
      ...
      {
        title: "CLT - Art. 58, § 2º - Declaração de Horas para Compensação",
        ...
        interpretation: "Em linguagem simples: DECLARAÇÃO DE HORAS para compensação = você pode declarar que vai compensar horas trabalhadas a mais! ⚠️ REGRAS: 1) Precisa ter acordo coletivo; 2) Máximo 10 horas por dia; 3) Compensação em até 1 ano. Se você declarar compensação de horas e tiver acordo coletivo, empresa NÃO pode descontar!",
        link: "http://www.planalto.gov.br/ccivil_03/decreto-lei/del5452.htm#art58"
      },
      {
      ...
      {
        title: "CLT - Art. 75 - Regulamento Interno e Declaração",
        ...
        interpretation: "Em linguagem simples: REGULAMENTO INTERNO pode aceitar ou não declaração de horas! ⚠️ ATENÇÃO: Algumas empresas aceitam declaração de horas, outras exigem atestado médico sempre. Consulte o regulamento da sua empresa! DICA: Se regulamento aceita declaração de horas, empresa DEVE aceitar e NÃO pode descontar!",
        link: "http://www.planalto.gov.br/ccivil_03/decreto-lei/del5452.htm#art75"
      },
      {
        title: "CLT - Art. 473 - Declaração de Horas para Falta Justificada",
        reference: "Consolidação das Leis do Trabalho - Artigo 473",
        content: "Não se considera falta ao serviço, para os efeitos do artigo anterior, a ausência do empregado nos seguintes casos: I - por motivo de casamento, até 3 (três) dias consecutivos; II - por falecimento do cônjuge, ascendente, descendente, irmão ou pessoa que, declarada em sua CTPS, viva sob sua dependência econômica, até 2 (dois) dias consecutivos; III - por motivo de doação voluntária de sangue devidamente comprovada, até 1 (um) dia por ano; IV - por motivo de alistamento eleitoral, nos termos da legislação respectiva; V - por motivo de vestibular para ingresso em estabelecimento de ensino superior.",
        interpretation: "Em linguagem simples: DECLARAÇÃO DE HORAS para essas situações = empresa NÃO pode descontar! Se você declarar que faltou por casamento, morte de parente, doação de sangue, vestibular, etc., empresa NÃO pode descontar do salário! ⚠️ IMPORTANTE: Declaração de horas protege você em faltas justificadas!",
        link: "http://www.planalto.gov.br/ccivil_03/decreto-lei/del5452.htm#art473"
      }
    ],
    ordinances: [
      {
        title: "Portaria MTE nº 1.510/2009 - Declaração de Horas para Compensação",
        reference: "Ministério do Trabalho e Emprego - Portaria 1.510/2009",
        content: "Estabelece procedimentos para controle de declaração de horas e compensação de jornada.",
        interpretation: "Em linguagem simples: PORTARIA regulamenta declaração de horas para compensação! Empresa DEVE aceitar declaração de horas quando há acordo coletivo. ⚠️ IMPORTANTE: Se você declarar compensação de horas e tiver acordo coletivo, empresa DEVE aceitar e NÃO pode descontar!",
        link: "https://www.gov.br/trabalho-e-emprego/"
      },
      {
        title: "Instrução Normativa SIT nº 97/2018 - Controle de Declaração de Horas",
        reference: "Secretaria de Inspeção do Trabalho - IN 97/2018",
        content: "Estabelece procedimentos para controle de ponto e registro de declaração de horas.",
        interpretation: "Em linguagem simples: IN regulamenta como empresa deve controlar declaração de horas! Empresa DEVE registrar quando você entrega declaração de horas. ⚠️ IMPORTANTE: Se empresa não registrar sua declaração de horas, pode ter problemas na fiscalização!",
    ...
    summaries: [
      ...
      },
      {
        ...
        interpretation: "Em linguagem simples: DECLARAÇÃO DE HORAS para compensação só vale com acordo coletivo! Se você declarar compensação de horas e tiver acordo coletivo, empresa DEVE aceitar e NÃO pode descontar! ⚠️ IMPORTANTE: Verifique se seu sindicato permite declaração de horas para compensação!",
        link: "https://www.tst.jus.br/sumulas"
      },
      {
        number: "Súmula 428",
        ...
        interpretation: "Em linguagem simples: DECLARAÇÃO DE HORAS = falta justificada! Empresa NÃO pode descontar quando você entrega declaração de horas, porque é falta justificada! ⚠️ IMPORTANTE: Declaração de horas impede desconto salarial!",
        link: "https://www.tst.jus.br/sumulas"
      },
      {
        number: "Súmula 119",
        ...
        interpretation: "Em linguagem simples: DECLARAÇÃO DE HORAS = sem desconto! Se você entregou declaração de horas, empresa NÃO pode descontar NADA do seu salário! ⚠️ IMPORTANTE: Declaração de horas protege 100% do seu salário!",
        link: "https://www.tst.jus.br/sumulas"
      }
    ],
    jurisprudence: [
      ...
      },
      {
        ...
        content: "Quando há acordo coletivo, declaração de horas para compensação é válida. O empregado pode declarar que vai compensar horas trabalhadas a mais e a empresa deve aceitar a declaração.",
        interpretation: "Em linguagem simples: DECLARAÇÃO DE HORAS para compensação = válida com acordo coletivo! Se você declarar que vai compensar horas e tiver acordo coletivo, empresa DEVE aceitar e NÃO pode descontar! ⚠️ IMPORTANTE: Verifique se seu sindicato permite declaração de horas!"
      },
      {
        title: "Empresa não pode recusar declaração de horas válida",
        content: "A empresa não pode recusar declaração de horas quando ela é válida conforme a CLT. Se o empregado entregar declaração de horas por motivo justo, a empresa deve aceitar.",
        interpretation: "Em linguagem simples: EMPRESA NÃO PODE recusar declaração de horas válida! Se você entregou declaração de horas por motivo justo, empresa DEVE aceitar! ⚠️ IMPORTANTE: Se empresa recusar declaração válida, você pode reclamar na Justiça do Trabalho!"
      },
      {
        title: "Declaração de horas protege contra desconto",
        content: "Declaração de horas protege o empregado contra desconto salarial. Quando há declaração de horas, a falta é considerada justificada e não pode resultar em desconto do salário.",
        interpretation: "Em linguagem simples: DECLARAÇÃO DE HORAS = PROTEÇÃO TOTAL contra desconto! Se você entregou declaração de horas, empresa NÃO pode descontar NADA do seu salário! ⚠️ IMPORTANTE: Declaração de horas é uma proteção legal!"
      },
      {
        title: "Regulamento interno e declaração de horas",
        content: "O regulamento interno pode aceitar ou não declaração de horas, mas não pode ser mais restritivo que a CLT. Se a CLT permite declaração de horas, o regulamento não pode proibir completamente.",
        interpretation: "Em linguagem simples: REGULAMENTO INTERNO pode aceitar ou não declaração de horas! ⚠️ ATENÇÃO: Se CLT permite declaração de horas (como para doença de 1 dia), regulamento não pode proibir completamente. DICA: Consulte o regulamento da sua empresa!"
      },
      {
        title: "Prova da declaração de horas",
        content: "O empregado deve guardar cópia da declaração de horas entregue. A empresa deve registrar o recebimento da declaração. Isso protege o empregado em caso de disputa.",
        interpretation: "Em linguagem simples: GUARDE cópia da declaração de horas! Empresa deve registrar que recebeu sua declaração. ⚠️ DICA: Sempre faça cópia da declaração de horas antes de entregar!"
      },
      {
        title: "Declaração de horas em situações especiais",
        content: "Declaração de horas é válida para casamento, morte de parente, doação de sangue, vestibular, etc. Em todas essas situações, a empresa não pode descontar do salário.",
        interpretation: "Em linguagem simples: DECLARAÇÃO DE HORAS para casamento, morte, doação de sangue, vestibular = empresa NÃO pode descontar! ⚠️ IMPORTANTE: Declaração de horas protege você em todas as faltas justificadas!"
      }
    ],
    recentDecisions: [
      {
